  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        "settings.readers.scanModeHelp": "Scan mode help text",
        "settings.tapMode": "Tap",
        "settings.insertMode": "Insert",
        "settings.readers.continuousScan": "Continuous Scan",
        "settings.readers.continuousScanHelp": "Continuous scan help text",
        "settings.readers.launchOnScan": "Launch on Scan",
        "settings.readers.launchOnScanHelp": "Launch on scan help text",
        "settings.readers.preferExternalReader": "Prefer External Reader",
        "settings.readers.preferExternalReaderHelp":
          "Prefer external reader help text",
        "settings.readers.shakeToLaunch": "Shake to Launch",
        "settings.readers.shakeToLaunchHelp": "Shake to launch help text",
        "settings.readers.audioFeedback": "Audio Feedback",
        "settings.readers.audioFeedbackHelp": "Audio feedback help text",
        "settings.readers.autoDetectReaders": "Auto Detect Readers",
        "settings.readers.autoDetectReadersHelp":
          "Auto detect readers help text",
