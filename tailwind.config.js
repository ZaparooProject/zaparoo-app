...
export default {
  ...
  theme: {
  	...
  	extend: {
  		backgroundImage: {
  			'button-pattern': 'radial-gradient(164.29% 190% at center top, #3FAEEC 0%, #4E4AF2 100%)',
  			'card-pattern': 'radial-gradient(68.44% 136.87% at center top, #333C4D 0%, #111928 100%)'
  		},
  		borderRadius: {
  			lg: 'var(--radius)',
